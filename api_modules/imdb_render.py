...
class MovieInfo():
    ...
    def get_movie_rating(self,API_KEY):
        rating_response = ImdbRequest.search_movie_rating(API_KEY,self.id)
    ...
    def get_movie_trailer(self,API_KEY):
        trailer_response = ImdbRequest.search_movie_trailer(API_KEY,self.id)
